class Livro:
    def __init__(self , codigo: int, titulo: str, preco: float, tipo: int, desconto_percentual: float = 0.0):
        if preco < 0:
        ...
        if tipo not in [1, 2]:
            raise ValueError("Tipo inválido. Use 1 para gratuito ou 2 para pago.")
